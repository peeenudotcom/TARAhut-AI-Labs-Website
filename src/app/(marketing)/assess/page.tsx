      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 py-28 text-center w-full">
          ...
          >
            <Link
              href="/assess/quiz"
              className="inline-block px-10 py-4 rounded-xl bg-gradient-to-r from-red-400 via-red-500 to-red-500 text-black font-medium shadow-[0_10px_40px_rgba(16,185,129,0.35)] hover:scale-105 hover:shadow-[0_20px_60px_rgba(16,185,129,0.5)] transition-all duration-300 text-lg"
            >
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="w-12 h-12 rounded-full bg-red-100 text-red-600 font-bold text-lg flex items-center justify-center mx-auto mb-4">
                  {item.step}
                </div>
          ...
          <div className="mt-12 text-center">
            <Link
              href="/assess/quiz"
              className="inline-block px-8 py-3 rounded-xl bg-red-600 text-white font-medium hover:bg-red-700 transition-colors"
            >
              Take the Assessment →
            </Link>
          </div>
