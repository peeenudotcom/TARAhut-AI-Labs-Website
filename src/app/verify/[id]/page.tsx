  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
      <div className="w-full max-w-2xl">
        ...
        {/* Certificate card */}
        <div className="bg-white rounded-2xl border-2 border-red-200 shadow-lg overflow-hidden print:shadow-none print:border">
          {/* Header */}
          <div className="bg-gradient-to-r from-red-600 to-red-600 px-8 py-6 text-center text-white">
            <h1 className="text-2xl font-bold">{siteConfig.name}</h1>
            <p className="text-red-100 text-sm mt-1">Certificate of Completion</p>
          </div>
          ...
          <div className="px-8 py-10 text-center">
            ...
            <h3 className="text-xl font-semibold text-red-700 mb-6">
              {cert.course_title}
            </h3>
